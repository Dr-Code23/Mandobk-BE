...
class MobileAuthController extends Controller
{
    ...
    public function login(LoginRequest $request): JsonResponse
    {
        ...
        if ($token = Auth::attempt(['username' => $username, 'password' => $password, 'status' => '1', 'role_id' => Role::where('name', 'visitor')->value('id')])) {
        ...
        return $this->forbiddenResponse(__('standard.not_authorized'), null, IlluminateHttpResponse::HTTP_UNAUTHORIZED);
    }
